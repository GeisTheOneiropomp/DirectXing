...
public:
    ...
    SSAmbientOcclusion(ID3D12Device* device,
        ID3D12GraphicsCommandList* cmdList,
        UINT width, UINT height);
    SSAmbientOcclusion(const SSAmbientOcclusion& rhs) = delete;
    SSAmbientOcclusion& operator=(const SSAmbientOcclusion& rhs) = delete;
    ~SSAmbientOcclusion() = default;
